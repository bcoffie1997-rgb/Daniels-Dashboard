...
type BrandmarkColor = "forest" | "cream";
...
const FILL: Record<BrandmarkColor, string> = {
  forest: "#004539",
  cream: "#FFFDFA",
};
...
export function Brandmark({
  ...
  className,
  color = "forest",
  ariaLabel = "Daniel's brandmark",
}: BrandmarkProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 54.114 51.315"
      width={size}
      height={size}
      role="img"
